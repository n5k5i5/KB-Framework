...
class KB_Modul_Arayuzu:
    """
    Base class for KB-OSINT modules.
    Each module should implement `calistir(params: Dict[str, Any]) -> Dict[str, Any]`
    returning a standard dict:
      {"durum": "basarili|hata", "mesaj": "...", "veri": {...}}
    """
    ...
    def __init__(self,
                 ...
                 reporting_engine: Optional[Any] = None,
                 integrations_bus: Optional[Any] = None):
        self.config = config or {}
        self.security = security_manager
        self.reporting = reporting_engine
        self.bus = integrations_bus
